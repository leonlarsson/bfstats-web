      ...
      <div className="flex h-14 items-center justify-between">
        ...
        <div className="hidden items-center gap-1 md:flex">
          <Link href="/" className={cn("mr-3 flex items-center gap-3 text-lg font-semibold")}>
            <Image src="/images/avatar.png" alt="Battlefield Stats icon" className="size-10 rounded" width={100} height={100} /> <span className={cn("opacity-75 transition-opacity", pathname === "/" && "opacity-100")}>Battlefield Stats</span>
          </Link>
