...
function Home() {
  return (
    <div>
      ...
      <h3 className="font-semibold text-2xl">User Data handling and usage</h3>
      <p>
      ...
      <h3 className="font-semibold text-2xl">User Locale, and how I use it</h3>
      <p>
      ...
      <h3 className="font-semibold text-2xl">Deleting your stats image***</h3>
      <p>
      ...
      <h3 className="font-semibold text-2xl">API information</h3>
      <p>
      ...
      <h3 className="font-semibold text-2xl">Viewing your usage statistics</h3>
      <p>
      ...
      <h3 className="font-semibold text-2xl">Requesting data redaction</h3>
      <p>
      ...
      <h3 className="font-semibold text-2xl">Output identifiers</h3>
      <p>
        ...
        <br />
        <Link className="link" href="https://api.battlefieldstats.com/outputs/FECbLioP" target="_blank">
          This
        </Link>{" "}
      ...
      <h3 className="font-semibold text-2xl">Disclaimers</h3>
      <p>
        <i>
