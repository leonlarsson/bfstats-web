  ...
  return (
    <div>
      ...
      <p>
        ...
        <a className="link" target="_blank" href="https://github.com/leonlarsson/bfstats-api">
          here
        </a>
      ...
      <p>
        ...
        <a className="link" target="_blank" href="https://battlefieldtracker.com/">
          Battlefield Tracker
        </a>{" "}
        and{" "}
        <a className="link" target="_blank" href="https://gametools.network/">
          Community Network
        </a>{" "}
        ...
        <br />
        <a className="link" target="_blank" href="https://help.ea.com/en/help/battlefield/battlefield-2042/battlefield-2042-stats-and-privacy/">
          Battlefield 2042
        </a>
        <br />
        <a className="link" target="_blank" href="https://help.ea.com/en/help/battlefield/battlefield-stats-display/">
          Battlefield V/1
        </a>
        <br />
        <br />
      ...
      <p>
        If you want your data (user ID and username) to be redacted in the private database, you need to reach out to me on Discord. My username is <q>mozzy</q>. Since I don't store any emails, emailing me does not work as verification. If you have your data redacted and then continue to use the
        bot, your data will once again be stored. Do not use the bot in this case.
      </p>
