  ...
  return (
    <>
      ...
      <div className="pb-3">
        ...
        <a className="link-primary fw-bold" target="_blank" href="https://github.com/leonlarsson/bfstats-api">
          here
        </a>
        ...
        <Link href="/data" className="link-primary fw-bold">
          data reporting page
        </Link>
      ...
      <div className="pb-3">
        ...
        This bot has access to the language your Discord client currently is set to. It uses this language to <strong>PUBLICLY</strong> display stats and messages in your language**. If you don't want the bot to use your client language, you must specify a language yourself with the "language"
      ...
      <div className="pb-3">
        ...
        <a className="link-primary fw-bold" target="_blank" href="https://battlefieldtracker.com/">
          Battlefield Tracker
        </a>{" "}
        and{" "}
        <a className="link-primary fw-bold" target="_blank" href="https://gametools.network/">
          Community Network
        </a>{" "}
        ...
        <br />
        <a className="link-primary fw-bold" target="_blank" href="https://help.ea.com/en/help/battlefield/battlefield-2042/battlefield-2042-stats-and-privacy/">
          Battlefield 2042
        </a>
        <br />
        <a className="link-primary fw-bold" target="_blank" href="https://help.ea.com/en/help/battlefield/battlefield-stats-display/">
          Battlefield V/1
        </a>
        <br />
        <br />
