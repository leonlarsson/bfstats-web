...
const ChartStyle = ({ id, config }: { id: string; config: ChartConfig }) => {
  ...
  return (
    <style
      // biome-ignore lint/security/noDangerouslySetInnerHtml: chart color CSS variables injected from controlled config
...
>(
  (
    ...
    const tooltipLabel = React.useMemo(() => {
      ...
      const [item] = payload;
      const dataKey = typeof item.dataKey !== "function" ? item.dataKey : undefined;
